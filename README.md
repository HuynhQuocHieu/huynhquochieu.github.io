<html chan="en">
    <head>
        ...
        <title> Nguyễn Anh Tấn </title>
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    </head>
    <!-- Head= chỉ để chỉnh sửa web ko hiện thị-->
    <style>
        *{
            margin:0;
            padding:0;
        ...
        body{
            background-image:url("https://tixiai.com.vn/wp-content/uploads/2018/06/long-exposure-fine-art-tutorial.jpg");
        ...
        table,tr,td{
            border:4px solid rgb(0, 168, 42);
            font-size: 2cm black;
        }
        .header{
            background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRIy59zwBOrVXvU5NGc5CRqjuA6jCqU8Jw8g&usqp=CAU");
            color:black;
            padding:60;
            text-align:center;
            font-size:30;
        ...
        .navbar {
        overflow: hidden;
        background-color: rgb(12, 61, 107);
        }
        .navbar a {
        float: left;
        display: block;
    ...
    <!-- style= tạo kiểu cho thẻ,có hiển thị-->
    <body>
        <div class="header">
        ...
        <a  href="https://anhtannguyen.github.io/20220506.11h.web5/"> <div class="ttct">Thông tin của tôi</div></a><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    </body>
</html>
